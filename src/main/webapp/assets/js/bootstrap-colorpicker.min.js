...
!function (a) {
    ...
    b.prototype = {
        ...
        HSLtoRGB: function (a, b, c, d) {
            ...
            var e;
            e = .5 >= c ? c * (1 + b) : c + b - c * b;
            var f = 2 * c - e, g = a + 1 / 3, h = a, i = a - 1 / 3, j = Math.round(255 * this.HueToRGB(f, e, g)),
                k = Math.round(255 * this.HueToRGB(f, e, h)), l = Math.round(255 * this.HueToRGB(f, e, i));
    ...
    d.Color = b, d.prototype = {
        constructor: d, destroy: function () {
            ...
            var a = this.container && this.container[0] !== document.body ? "position" : "offset",
                b = this.component || this.element, c = b[a]();
